...
function showProducts() {
  ...
  for (var i = 0; i < productContainer.length; i++) {
    rows +=
      ...
      i +
      ')"></i></div><img class="img-fluid" src="images/3191.png" class="card-img-top" alt="test"><div class="card-body"><h5 class="card-title">' +
...
function updateProduct(index) {
  ...
  productModel.value = productContainer[index].productModel;
